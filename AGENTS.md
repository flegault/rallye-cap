...
- `Alignement` prépare et valide l'horaire avec `Prêt à jouer`. `Jouer` porte le démarrage, la progression et les changements de joueurs, en vue complète ou simple.
